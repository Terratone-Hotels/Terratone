  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:h-[450px] lg:h-[533px] xl:h-[735px] overflow-hidden">
        ...
        <div className="flex flex-col justify-between w-full md:w-[45%] pr-4 pt-4 md:pt-0">
          {/* Heading */}
        ...
        <div className="flex flex-row h-[350px] md:h-full md:w-[55%] items-center gap-4 lg:gap-6 mt-4 md:mt-0">
