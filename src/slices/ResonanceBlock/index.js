...
const ResonanceBlock = ({ slice }) => {
  // ⭐ ULTRA CINEMATIC PARALLAX EFFECT (40–50% TRAVEL)
  useEffect(() => {
    ...
    containers.forEach((container) => {
      ...
      gsap.fromTo(
        img,
        { y: "-10%" }, // starts way above
        {
          y: "20%", // travels deep downward
          ease: "none",
          scrollTrigger: {
            trigger: container,
            start: "top bottom", // starts early
            end: "bottom top", // ends late
            scrub: 1.4, // buttery smooth
          },
        }
      );
    });
        ...
        >
          ...
          <div className="parallax-container overflow-hidden">
            <PrismicNextImage
              ...
              className="parallax-img h-[15.625rem] object-cover lg:h-[33.938rem]"
            />
          </div>
          ...
          <div className="-mt-45 md:-mt-55 lg:-mt-110 flex flex-col items-center top-0 ">
            ...
            {/* Vertical Image */}
            <div className="parallax-container overflow-hidden w-auto lg:w-[27.938rem] mt-4 md:mt-5 lg:mt-10">
              <PrismicNextImage
                field={slice.primary.vertical_image}
                className="parallax-img h-[16rem] w-[13rem] lg:w-[27.938rem] lg:h-[33.938rem] object-cover"
              />
            </div>
          </div>
      ...
      {slice.variation === "roomNarrative" && (
        ...
        >
          ...
          <div className="parallax-container overflow-hidden">
            <PrismicNextImage
              field={slice.primary.horizontal_image}
              className="parallax-img h-[196px] w-full object-cover lg:h-[620px]"
            />
          </div>

          {/* Desktop: overlapping section */}
          <div className="hidden w-full h-[425px] lg:flex flex-row justify-between items-center">
            ...
            {/* Vertical Image */}
            <div className="parallax-container overflow-hidden lg:w-[27.938rem] -mt-45 md:-mt-55 lg:-mt-70 z-10">
              <PrismicNextImage
                field={slice.primary.vertical_image}
                className="parallax-img h-[16rem] w-[13rem] lg:w-[27.938rem] lg:h-[33.938rem] object-cover"
              />
          ...
          <div className="lg:hidden">
            <div className="flex flex-col items-center -mt-20">
              ...
              <div className="parallax-container overflow-hidden">
                <PrismicNextImage
                  field={slice.primary.vertical_image}
                  className="parallax-img h-[14rem] w-[10rem] z-10 object-cover"
                />
              </div>
